...
export default function Mousemove() {
  ...
  return (
    <div className="  gap-[24px]   ">
      <motion.div
        className="  bg-[#1d1c20] border border-[#ffffff14] rounded-[24px]   "
        onMouseMove={handleMouseMove}
      >
        <motion.div className="relative  overflow-hidden min-h-[450px] p-[32px]  w-full  ">
          ...
          <motion.div className="relative h-full -bottom-16 flex ">
            ...
            <motion.div
              className={classNames(
                "w-[200px] h-[200px] [box-shadow:0_20px_25px_#00000080,_inset_0_2px_2px_#525154] [background-image:linear-gradient(#343236,#38343f)] ",
                "rotate-[2deg] z-[4] rounded-[32px] relative  overflow-hidden flex flex-col shrink-0 items-center justify-center   ",
              )}
              ref={first}
            >
              <img
            ...
            <motion.div
              className={classNames(
                "w-[200px] h-[200px] rotate-[-2deg] z-[2] [box-shadow:0_20px_25px_#00000080,_inset_0_2px_2px_#525154] ",
                "[background-image:linear-gradient(#343236,#38343f)] rounded-[32px] relative shrink-0  overflow-hidden",
